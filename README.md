...
> [!TIP]
> Jika Anda mengalami error saat instalasi `paddleocr` atau `paddlepaddle`, pastikan Anda sudah menginstal [Visual C++ Redistributable](https://aka.ms/vs/16/release/vc_redist.x64.exe).
